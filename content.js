...
const COLUMN_IFRAME_CSS = Object.freeze({
    ...
    top_hidden_list: `div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1) :is(button, a, input, [role="button"], [role="link"], [role="tab"]){display: none;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1) h2[role="heading"] + div{display: none;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1) h2[role="heading"] svg{display: none;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1) h2[role="heading"]{width: 100%;text-align: center;}div[data-testid="cellInnerDiv"]:has(button[aria-describedby], div[data-testid="UserAvatar-Container-unknown"]):not(:has(article[tabindex="-1"])){display:none;}`,
