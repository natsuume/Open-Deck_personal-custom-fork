...
//top_hidden_list はリスト系ページ向けで、トップヘッダーをリスト名だけの専用バーに整形する: ヘッダー本体 (最初の子要素。2 つ目の子要素は「新しいポスト」のピル) の高さ・背景・sticky は X 標準のまま残し、
//ボタン (戻る・共有・メニュー)・見出し直後のオーナー行・見出し (h2[role="heading"]) 内のアイコン (非公開リストの鍵) を display:none で余白ごと除き、見出しの親を中央揃えにして見出しをバー中央に置く。
//安全網として、ヘッダー本体の子要素を visibility:hidden にしたうえで見出しだけ visible に戻し、列挙に無い要素が見えたり操作できたりしないようにする (その要素の余白は残る)
const COLUMN_IFRAME_CSS = Object.freeze({
    banner_hidden: `header[role="banner"]{display:none}`,
    top_hidden_list: `div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child>*{visibility: hidden;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child h2[role="heading"]{visibility: visible;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child button{display: none;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child h2[role="heading"] + div{display: none;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child h2[role="heading"] svg{display: none;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child div:has(> h2[role="heading"]){align-items: center;width: 100%;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child h2[role="heading"]{text-align: center;}div[data-testid="cellInnerDiv"]:has(button[aria-describedby], div[data-testid="UserAvatar-Container-unknown"]):not(:has(article[tabindex="-1"])){display:none;}`,
