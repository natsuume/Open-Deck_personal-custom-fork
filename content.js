...
const COLUMN_IFRAME_CSS = Object.freeze({
    ...
    top_hidden_list: `div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child button{display: none;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child h2[role="heading"] + div{display: none;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child h2[role="heading"] svg{display: none;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child div:has(> h2[role="heading"]){align-items: center;width: 100%;}div[data-testid="primaryColumn"]>[tabindex="0"][aria-label]>div:nth-child(1)>div:first-child h2[role="heading"]{text-align: center;}div[data-testid="cellInnerDiv"]:has(button[aria-describedby], div[data-testid="UserAvatar-Container-unknown"]):not(:has(article[tabindex="-1"])){display:none;}`,
